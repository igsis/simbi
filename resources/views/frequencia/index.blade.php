                ...
                <tr>
                    ...
                    <td>
                        @if($type == 1)
                            ...
                            <a href="{{ route('frequencia.portaria.cadastro', $equipamento->id) }}" class="btn btn-success" style="margin-right: 3px"><i class="glyphicon glyphicon-plus-sign"></i> Publico Atendido</a>
                        @else
                            ...
                            <a href="{{ route('frequencia.portaria.listar', $equipamento->id) }}" class="btn btn-warning" style="margin-right: 3px"><i class="glyphicon glyphicon-stats"></i> Frequência Público Atendido</a>
                        @endif
                    </td>
                </tr>
            @endforeach
