    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <form method="POST" action="{{ route('funcionario.atualizar', $user->id) }}" accept-charset="UTF-8">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group col-md-12 has-feedback {{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name">Nome</label>
                            <input class="form-control" type="text" name="name" id="name" value="{{$user->nome}}">
                        </div>
                        ...
                        <div id="divFuncao"
                            ...
                            <select class="form-control" name="funcao" id="funcao">
                                ...
                                @foreach ($funcoes as $funcao)
                                    @if ($funcao->id == old('funcao') || $funcao->id == $user->funcao_id)
...
{{--                            <input class="form-control" type="text" name="lotacao" value="@isset($user->lotacao) @endisset">--}}
{{--                        </div>--}}
                    </div>
                    @endhasanyrole
