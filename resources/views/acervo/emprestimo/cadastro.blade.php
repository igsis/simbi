...
@section('conteudo')
    ...
    <form method="POST" action="{{ route('emprestimo.gravar', $equipamento->id) }}" autocomplete="off">
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="form-group col-md-offset-3 col-md-3">
                ...
                <input type="number" class="form-control" name="manga" id="manga"
                       value="{{ old('manga') }}" onblur="calcular()" onkeyup="calcular()">
            </div>
            <div class="form-group col-md-3">
                <label for="revista">Revista</label>
                <input type="number" class="form-control" name="revista" id="revista"
                       value="{{ old('revista') }}" onblur="calcular()" onkeyup="calcular()">
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-offset-3 col-md-3">
                ...
                <input type="number" class="form-control" name="suportes" id="suportes"
                       value="{{ old('suportes') }}" onblur="calcular()" onkeyup="calcular()">
            </div>
            <div class="form-group col-md-3">
