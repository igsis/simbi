...
@section('conteudo')
    ...
    <form method="POST" action="{{ route('matricula.update', [$equipamento->id, $matricula->id]) }}" autocomplete="off">
        {{ csrf_field() }}

        <div class="row">
            <div class="form-group col-md-offset-3 col-md-3">
                <label for="data">Mês - Ano</label>
                <input type="text" class="form-control" id="calendario" name="data" value="{{ date('m/d/Y', strtotime($matricula->data)) }}" autocomplete="off" maxlength="10">
            </div>
        ...
        <div class="row">
            <div class="form-group col-md-offset-3 col-md-3">
                ...
                <input type="number" class="form-control" name="nova" id="nova"
                       value="{{ $matricula->nova }}" onblur="calcular()" onkeyup="calcular()">
            </div>
            <div class="form-group col-md-3">
                <label for="audioVisual">Renovação de Matrículas</label>
                <input type="number" class="form-control" name="renovacao" id="renovacao"
                       value="{{ $matricula->renovacao  }}" onblur="calcular()" onkeyup="calcular()">
            </div>
        </div>
