                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xs-12 col-md-6 has-feedback {{ $errors->has('equipamentoSigla') ? ' has-error' : '' }}">
                                ...
                                <input class="form-control" name="equipamentoSigla" id="equipamentoSigla"
                                       value="{{ $equipamento->equipamento_sigla }}">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="nome_tematica" id="nome_tematica"
                                       value="{{$equipamento->nome_tematica}}" disabled>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control" name="cep" id="cep" data-mask="00000-000"
                                       placeholder="xxxxx-xxx" value="{{ $equipamento->endereco->cep }}">
                            </div>
                            <div class="form-group col-md-10">
                                <label for="logradouro">Logradouro</label>
                                <input type="text" class="form-control" name="logradouro" id="logradouro"
                                       value="{{$equipamento->endereco->logradouro}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-2">
                                ...
                                <input type="text" class="form-control" name="numero" id="numero"
                                       value="{{$equipamento->endereco->numero}}">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="complemento">Complemento</label>
                                <input type="text" class="form-control" name="complemento" id="complemento"
                                       value="{{$equipamento->endereco->complemento}}">
                            </div>

                            <div class="form-group col-md-3">
                                <label for="bairro">Bairro</label>
                                <input type="text" class="form-control" name="bairro" id="bairro"
                                       value="{{$equipamento->endereco->bairro}}" readonly>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="cidade">Cidade</label>
                                <input type="text" class="form-control" name="cidade" id="cidade"
                                       value="{{$equipamento->endereco->cidade}}" readonly>
                            </div>

                            <div class="form-group col-md-1">
                                <label for="uf">UF</label>
                                <input type="text" class="form-control" name="uf" id="uf"
                                       value="{{$equipamento->endereco->estado}}" readonly>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-offset-3 col-md-8" style="padding-bottom: 15px">
                                                ...
                                                <input type="checkbox" name="domingo[0]" value="1"/><label
                                                        for="diasemana07" style="padding:0 10px 0 5px;"> Domingo</label>
                                                <input type="checkbox" name="segunda[0]" value="1"/><label
                                                        for="diasemana01" style="padding:0 10px 0 5px;"> Segunda</label>
                                                <input type="checkbox" name="terca[0]" value="1"/><label
                                                        for="diasemana02" style="padding:0 10px 0 5px;"> Terça</label>
                                                <input type="checkbox" name="quarta[0]" value="1"/><label
                                                        for="diasemana03" style="padding:0 10px 0 5px;"> Quarta</label>
                                                <input type="checkbox" name="quinta[0]" value="1"/><label
                                                        for="diasemana04" style="padding:0 10px 0 5px;"> Quinta</label>
                                                <input type="checkbox" name="sexta[0]" value="1"/><label
                                                        for="diasemana05" style="padding:0 10px 0 5px;"> Sexta</label>
                                                <input type="checkbox" name="sabado[0]" value="1"/><label
                                                        for="diasemana06" style="padding:0 10px 0 5px;"> Sábado</label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @foreach($equipamento->funcionamentos()->where('publicado', '=', '1')->get() as $key => $funcionamento)
                                    <div class="horario">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-offset-3 col-md-8" style="padding-bottom: 15px">
                                                    <input type="hidden" name="funcionamento[{{$key}}]"
                                                           value="{{$funcionamento->id}}">
                                                    <input type="checkbox" name="domingo[{{$key}}]"
                                                           value="1" {{$funcionamento->domingo == 1 ? "checked" : ""}}/><label
                                                            for="diasemana07" style="padding:0 10px 0 5px;">
                                                        Domingo</label>
                                                    ...
                                                    <input type="checkbox" name="terca[{{$key}}]"
                                                        ...
                                                        Terça</label>
                                                    <input type="checkbox" name="quarta[{{$key}}]"
                                                           value="1" {{$funcionamento->quarta == 1 ? "checked" : ""}}/><label
                                                            for="diasemana03" style="padding:0 10px 0 5px;">
                                                        Quarta</label>
                                                    <input type="checkbox" name="quinta[{{$key}}]"
                                                           value="1" {{$funcionamento->quinta == 1 ? "checked" : ""}}/><label
                                                            for="diasemana04" style="padding:0 10px 0 5px;">
                                                        Quinta</label>
                                                    <input type="checkbox" name="sexta[{{$key}}]"
                                                           value="1" {{$funcionamento->sexta == 1 ? "checked" : ""}}/><label
                                                            for="diasemana05" style="padding:0 10px 0 5px;">
                                                        Sexta</label>
                                                    <input type="checkbox" name="sabado[{{$key}}]"
                                                           value="1" {{$funcionamento->sabado == 1 ? "checked" : ""}}/><label
                                                            for="diasemana06" style="padding:0 10px 0 5px;">
                                                        Sábado</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-offset-4 col-md-2">
                                                <label for="horarioAbertura">Horário de Abertura</label>
                                                <input type="text" class="form-control" name="horarioAbertura[{{$key}}]"
                                                       id="horarioAbertura" data-mask="00:00"
                                                       value="{{$funcionamento->hora_inicial}}">
                                            </div>
                                            <div class="form-group col-md-2">
                                                <label for="horarioFechamento">Horário de Fechamento</label>
                                                <input type="text" class="form-control"
                                                       name="horarioFechamento[{{$key}}]" id="horarioFechamento"
                                                       data-mask="00:00" value="{{$funcionamento->hora_final}}">
                                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" name="observacao" id="observacao"
                                       value="{{ $equipamento->observacao }}" placeholder disabled>
                            </div>

                            <div class="form-group col-md-3">
                                <label for="ocorrencia">Adicionar Nota</label>
                                <button type="button" id="ocorrencia" class="btn btn-info btn-block" data-toggle="modal"
                                        data-id="{{$equipamento->id}}" data-target="#addOcorrencia"><span
...
@section('scripts_adicionais')
    ...
    <script>
        var i = 0;
        let funci = [];
        $.getJSON('{{route('api.funcionamentos')}}', function (datas) {
