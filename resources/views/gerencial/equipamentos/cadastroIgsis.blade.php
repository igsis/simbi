    ...
    <form method="POST" action="{{ route('equipamentos.index') }}" autocomplete="off">
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-4 col-md-2">
                ...
                <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target="#addServico"><span
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-4 col-md-2">
                ...
                <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target="#addSubAdmin">
                    <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span></button>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="text" class="form-control" name="telefone" id="telefone" data-mask="(11) 0000-0000"
                       placeholder="(11) xxxx-xxxx"
                       value="{{ isset($equipamentoIgsis->telefone)?$equipamentoIgsis->telefone: old('telefone') }}">
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-2 has-feedback {{ $errors->has('cep') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" name="cep" id="cep" data-mask="00000-000"
                       ...
                       value="{{isset($equipamentoIgsis->cep) ? $equipamentoIgsis->cep : old('cep')}}">
            </div>
            <div class="form-group col-md-10">
                <label for="logradouro">Logradouro</label>
                <input type="text" class="form-control" name="logradouro" id="logradouro" readonly
                       value="{{isset($equipamentoIgsis->logradouro)?$equipamentoIgsis->logradouro:old('logradouro')}}">
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-md-2 has-feedback {{ $errors->has('numero') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" name="numero" id="numero"
                       value="{{isset($equipamentoIgsis->numero)?$equipamentoIgsis->numero:old('numero')}}">
            </div>

            <div class="form-group col-md-3 has-feedback {{ $errors->has('complemento') ? ' has-error' : '' }}">
                <label for="complemento">Complemento</label>
                <input type="text" class="form-control" name="complemento" id="complemento"
                       value="{{isset($equipamentoIgsis->complemento)?$equipamentoIgsis->complemento:old('complemento')}}">
            </div>

            <div class="form-group col-md-3">
                <label for="bairro">Bairro</label>
                <input type="text" class="form-control" name="bairro" id="bairro" readonly
                       value="{{isset($equipamentoIgsis->bairro)?$equipamentoIgsis->bairro: old('bairro')}}">
            </div>

            <div class="form-group col-md-3">
                <label for="cidade">Cidade</label>
                <input type="text" class="form-control" name="cidade" id="cidade" readonly
                       value="{{isset($equipamentoIgsis->cidade)?$equipamentoIgsis->cidade : old('cidade')}}">
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-xs-4 col-md-2">
                ...
                <button type="button" class="btn btn-info btn-block" data-toggle="modal" data-target="#addDistrito">
                    <span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span></button>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-8 has-feedback {{ $errors->has('observacao') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" name="observacao" id="observacao" value="{{old('observacao')}}"
                       disabled>
            </div>
        </div>
        <div class="row">
