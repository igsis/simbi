...
Route::group(['prefix' => '{equipamento_igsis}/eventos'], function (){
    ...
    Route::get('/cadastro/ocorrencia/{evento_igsis?}', 'FrequenciaController@cadastrarOcorrencia')->name('eventos.cadastro.ocorrencia');

    Route::post('/cadastro/ocorrencia/{evento_igsis?}', 'FrequenciaController@gravaOcorrencia')->name('eventos.grava.ocorrencia');
